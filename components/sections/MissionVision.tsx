      ...
      <div className="container">
        <Reveal className="max-w-3xl">
          ...
          <h2 id="mission-vision-title" className="mt-4 text-3xl font-semibold tracking-[-0.03em] md:text-5xl">
            {titleCase(about.missionVisionTitle)}
          </h2>
        </Reveal>

        <div className="mt-10 grid items-stretch gap-6 md:grid-cols-2">
          <Reveal className="h-full">
            <article className="surface-soft h-full min-h-[18rem] rounded-3xl border border-brand-border p-6 md:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-blue">{about.mission.label}</p>
              <h3 className="mt-4 max-w-md text-2xl font-semibold tracking-tight">{titleCase(about.mission.short)}</h3>
          ...
          <Reveal delay={60} className="h-full">
            <article className="surface-soft h-full min-h-[18rem] rounded-3xl border border-brand-border p-6 md:p-8">
              ...
              <h3 className="mt-4 max-w-md text-2xl font-semibold tracking-tight">{titleCase(about.vision.short)}</h3>
