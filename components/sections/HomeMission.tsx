...
import { NetworkIntelligenceVisual, NeuralSystemsVisual } from "@/components/AnimatedTechVisuals";
          ...
          <Reveal delay={60}>
            <div className="grid gap-4 sm:grid-cols-2">
              <figure className="surface-soft overflow-hidden rounded-3xl border border-brand-border">
                <NetworkIntelligenceVisual id="home-mission-network" className="h-auto w-full" />
              ...
              <figure className="surface-soft overflow-hidden rounded-3xl border border-brand-border">
                <NeuralSystemsVisual id="home-mission-neural" className="h-auto w-full" />
                <figcaption className="surface-panel border-t border-brand-border px-4 py-3 text-center text-[0.58rem] font-semibold uppercase leading-[1.3] tracking-[0.08em] text-brand-charcoal sm:text-[0.63rem]">
                  {neuralCaption}
                </figcaption>
              </figure>
