...
const TEXT = {
  es: {
    ...
    subtitle: "Recolecta señales de datos, evita interferencias y deja que el copiloto IA trace la ruta cuando quieras.",
    home: "Volver al home",
    reset: "Reiniciar",
    autopilot: "Copiloto IA",
    manual: "Manual",
    ...
    hint: "Usa flechas, WASD, click/touch, joystick móvil o activa el copiloto IA.",
    complete: "Automatización lista",
  },
  en: {
    eyebrow: "AI game",
    title: "ZQX AI Signal Sprint",
    subtitle: "Collect data signals, avoid interference, and let the AI copilot route the work when you want.",
    home: "Back home",
    reset: "Reset",
    ...
    hint: "Use arrows, WASD, click/touch, mobile joystick, or turn on the AI copilot.",
